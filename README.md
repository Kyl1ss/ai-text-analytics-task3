# EMATM0067 - Task 3: Comparative Corpus Analysis
...
## Folder Structure
1. /data/       — saved datasets (CSV, NPZ, NPY files)
2. /notebooks/  — one notebook per person
3. /results/    — plots and output tables
4. /report/     — LaTeX files